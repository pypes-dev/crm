...
import { Brain, Mail, Phone, Plus, Search, Filter, TrendingUp, Users, DollarSign, Clock, ChevronDown, BarChart3, Calendar, Globe, MapPin, Link, Settings, ExternalLink, FileText, Upload, Eye } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="md:hidden bg-white border-b border-gray-200 px-6">
        <div className="flex space-x-1 overflow-x-auto">
          <button
            onClick={() => setActiveTab('leads')}
            className={`flex-shrink-0 px-4 py-3 text-center font-medium transition-all duration-200 ${
              activeTab === 'leads'
